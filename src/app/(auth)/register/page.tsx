...
function RegisterPage() {
	...
	return (
		<div className="flex items-center justify-center h-screen">
			<div className="flex flex-col items-center justify-center mx-auto w-full max-w-lg rounded-none border border-solid border-white/30 bg-white p-4 shadow-input dark:bg-black md:rounded-2xl md:p-8">
				<h2 className="text-center text-3xl font-bold text-neutral-800 dark:text-neutral-200">
					Welcome to ByteSized
				</h2>
				<p className="mt-2 max-w-sm text-center text-base text-neutral-600 dark:text-neutral-300">
				...
				<div className="mt-8 text-center text-base text-neutral-600 dark:text-neutral-300">
